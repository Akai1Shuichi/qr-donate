(function(){
	...
	form.addEventListener('submit', function(evt){
		...
		if(amountNum < 8000){
			alert('Vui lòng nhập số tiền tối thiểu 8.000đ');
			return;
		}
		...
		qrDesc.textContent = `Số tiền: ${amountNum.toLocaleString('vi-VN')}đ • Nội dung: ${description}`;
		qrLink.href = url;
	...
	function buildVietQrUrl({bankId, accountNo, template, amount, addInfo, accountName}){
